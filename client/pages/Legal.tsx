      ...
      <section className="px-6 py-16 bg-gradient-to-br from-brand-blue to-blue-700 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl opacity-90">
            Find answers, understand our terms, and learn about how we protect
            your privacy
          </p>
        </div>
      </section>
                  ...
                  <div className="space-y-4">
                    <div className="border-l-4 border-brand-blue pl-4">
                      ...
                      <p className="text-gray-600 mt-1">
                        Click the "Enroll Now" button on any course card, fill
                        out the registration form, and complete payment to
                        secure your spot.
                      </p>
                    </div>
                    <div className="border-l-4 border-brand-blue pl-4">
                      ...
                      <p className="text-gray-600 mt-1">
                        We accept bank transfers, debit cards, and mobile money
                        payments. Installment plans are available for selected
                        courses.
                      </p>
                    </div>
                    <div className="border-l-4 border-brand-blue pl-4">
                      ...
                      <p className="text-gray-600 mt-1">
                        Our courses feature live instructor-led sessions with
                        recorded materials for review. You'll get the best of
                        both worlds!
                      </p>
                    </div>
                    <div className="border-l-4 border-brand-blue pl-4">
                      ...
                      <p className="text-gray-600 mt-1">
                        Yes! Upon successful completion, you'll receive an
                        industry-recognized certificate that you can add to your
                        LinkedIn profile.
                      </p>
                    </div>
                  </div>
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 leading-relaxed">
                    ...
                    <li>
                      Refunds are available within 7 days of enrollment if no
                      course materials have been accessed
                    </li>
                    <li>
                      Course prices are subject to change without prior notice
                    </li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 leading-relaxed">
                    ...
                    <li>
                      Students are responsible for attending live sessions or
                    ...
                    <li>
                      Course materials are for personal use only and may not be
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    Users are expected to maintain professional conduct during
                    all interactions. Harassment, spam, or disruptive behavior
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <p className="text-sm text-blue-800">
                    <strong>Last Updated:</strong> December 2024. These terms
                    may be updated periodically. Continued use of our services
              ...
              <div className="space-y-6 text-gray-700">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 leading-relaxed">
                    ...
                    <li>
                      Course data: progress, completion status, and performance
                      metrics
                    </li>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-2 leading-relaxed">
                    ...
                    <li>
                      Send course updates, announcements, and educational
                      content
                    </li>
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    policy. We may share information with trusted third parties
                ...
                <div>
                  ...
                  <p className="leading-relaxed">
                    ...
                    contact us at aether.hub1@gmail.com or through our support
                    channels.
                  </p>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <p className="text-sm text-green-800">
                    <strong>Last Updated:</strong> December 2024. We may update
                    this policy periodically. We will notify you of any material
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>
                  <a href="/innovation" className="hover:text-white">
                    Innovation
                  </a>
                </li>
              </ul>
