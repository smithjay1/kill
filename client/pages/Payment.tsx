...
export default function Payment() {
  ...
  const [step, setStep] = useState<"payment" | "proof" | "confirming">(
    "payment",
  );
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-2 text-gray-600">
                      <p>
                        <strong>Name:</strong>{" "}
                        {enrollmentData.studentInfo.firstName}{" "}
                      ...
                      <p>
                        <strong>Phone:</strong>{" "}
                        {enrollmentData.studentInfo.phone}
                      </p>
                    </div>
                  </div>
                  <div>
                    ...
                    <div className="space-y-2 text-gray-600">
                      <p>
                        ...
                        {enrollmentData.courseInfo.category}
                      </p>
                      <p>
                        <strong>Level:</strong>{" "}
                        {enrollmentData.courseInfo.level}
                      </p>
                      <p>
                        <strong>Duration:</strong>{" "}
                        {enrollmentData.courseInfo.duration}
                      </p>
                      <div className="flex items-center space-x-2">
              ...
              <CardContent className="p-6">
                ...
                <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
                  ...
                  <ul className="text-yellow-800 text-sm space-y-1">
                    ...
                    <li>
                      • Enrollment will be confirmed within 24 hours of payment
                      verification
                    </li>
                  </ul>
                </div>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
                  Great! Now please submit your payment screenshot through
                  either WhatsApp or Email. Your enrollment details and course
                ...
                <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                  <Card
                    ...
                    onClick={
                      isSubmitting ? undefined : handleWhatsAppSubmission
                    }
                  >
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-gray-600 text-sm mb-4">
                        Send payment proof via WhatsApp with pre-filled course
                        details
                      </p>
                      <Button
                  ...
                  >
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-gray-600 text-sm mb-4">
                        Send payment proof via email with pre-filled enrollment
                        information
                      </p>
                      <Button
                ...
                <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                  <p className="text-blue-800 text-sm">
                    <strong>Note:</strong> Your course details and student
                    information will be automatically included in the message.
            ...
            <Card className="max-w-md mx-auto">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600 mb-4">
                  Your enrollment has been successfully submitted. You'll be
                  redirected to continue with your proof submission.
                </p>
